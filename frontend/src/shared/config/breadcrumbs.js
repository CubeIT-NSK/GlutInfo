    ...
    children: [
      {
        ...
        children: [
          ...
          { name: 'profile-patient', label: 'Профиль пациента', link: '/profile-patient/:userId' },
          { name: 'fill-patient', label: 'Заполнение профиля пациента', link: '/profile-patient/fill' },
          { name: 'fill-patient', label: 'Заполнение профиля пациента', link: '/profile-patient/:userId/fill' },
          { name: 'edit-profile-patient', label: 'Редактирование профиля пациента', link: '/profile-patient/edit' },
          { name: 'edit-profile-patient', label: 'Редактирование профиля пациента', link: '/profile-patient/:userId/edit' },
          { name: 'my-consultations', label: 'Мои консультации', link: '/profile-patient/my-consultations' },
          { name: 'my-consultations', label: 'Мои консультации', link: '/profile-patient/:userId/my-consults' },
          { name: 'make-appointment', label: 'Записаться на консультацию', link: '/profile-patient/make-appointment' },
          { name: 'make-appointment', label: 'Записаться на консультацию', link: '/profile-patient/:userId/make-appointment' },
          { name: 'documents', label: 'Документы', link: '/profile-patient/my-documents' },
          { name: 'documents', label: 'Документы', link: '/profile-patient/:userId/my-documents' },
          { name: 'messages', label: 'Сообщения', link: '/profile-patient/messages' },
          { name: 'messages', label: 'Сообщения', link: '/profile-patient/:userId/messages' },
        ],
      },
      {
        name: 'consultant',
        label: 'Консультант',
        children: [
          { name: 'profile-consultant', label: 'Профиль консультанта', link: '/profile-consultant/:userId' },
