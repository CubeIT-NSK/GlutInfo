...
def upgrade() -> None:
    ...
    op.create_table('consultantcategory',
    ...
    op.create_table('consultantextended',
    ...
    sa.Column('description1_ru', sa.Text(), nullable=True),
    sa.Column('description1_en', sa.Text(), nullable=True),
    sa.Column('description2_ru', sa.Text(), nullable=True),
    sa.Column('description2_en', sa.Text(), nullable=True),
    sa.Column('education_ru', sa.Text(), nullable=True),
    sa.Column('education_en', sa.Text(), nullable=True),
    sa.Column('work_experience', sa.Integer(), nullable=True),
    sa.Column('scientific_works_count', sa.Integer(), nullable=True),
    sa.Column('video_presentation', sa.Text(), nullable=True),
    sa.Column('photo_gallery', postgresql.ARRAY(sa.Text()), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['category_id'], ['consultantcategory.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('consultantservice',
    sa.Column('consultant_id', sa.Integer(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['consultant_id'], ['consultantextended.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('consultantreview',
    sa.Column('consultant_id', sa.Integer(), nullable=False),
    sa.Column('reviewer_name', sa.String(length=255), nullable=False),
    sa.Column('rating', sa.Integer(), nullable=False),
    sa.Column('review_date', sa.Date(), nullable=False),
    sa.Column('review_text_ru', sa.Text(), nullable=False),
    sa.Column('review_text_en', sa.Text(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('consultantreview')
    op.drop_table('consultantservice')
    ...
    op.drop_table('consultantreview')
    op.drop_table('consultantservice')
    op.drop_table('consultantextended')
    op.drop_table('consultantcategory')
    op.drop_table('consultantextended')
    op.drop_table('consultantcategory')
