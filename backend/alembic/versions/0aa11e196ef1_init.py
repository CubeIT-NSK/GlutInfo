...
Revision ID: 0aa11e196ef1
Revises: 
Create Date: 2024-10-30 18:08:36.164365
...
def upgrade() -> None:
    ...
    sa.Column('duration', sa.Interval(), server_default='30 minutes', nullable=False),
    sa.Column('consultant_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['consultant_id'], ['consultants.id'], ),
    sa.PrimaryKeyConstraint('id')
