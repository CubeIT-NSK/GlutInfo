    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.mainContent}>
                <section className={styles.gsrsSection}>
                    <form className={styles.questionsForm} onSubmit={handleSubmit(submitResults)}>
                        {submitted ? (
                            ...
                            currentQuestionBlock && (
                                <>
                                    <div className={styles.gsrsTitlesWrapper}>
                                        <h1 className={styles.gsrsTitle}>Опросник GSRS</h1>
                                            ...
                                            {currentQuestionBlock.questions?.map((question, q_idx) => (
                                                <div key={q_idx} className={styles.questionBlock}>
                                                    <div className={styles.titleWrapper}>
                                                        ...
                                                        <h2 className={styles.gsrsSubTitle}>
                                                            {question.title}
                                                        </h2>
                                                    </div>
